#Massive Web Tester
#Script allows you to test a list of website for their IP Address, HTTPS and HTTP protocol, and redirect links
#Created by Stat1c_null https://github.com/Stat1c-Null
...
def main():
  ...
  #Read from file and save websites
